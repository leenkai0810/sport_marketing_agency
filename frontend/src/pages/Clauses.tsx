...
const Clauses = () => {
    ...
    const sections = [
        {
            title: t('clauses.section1Title'),
            content: t('clauses.section1Desc'),
        },
        {
            title: t('clauses.section2Title'),
            content: t('clauses.section2Desc'),
        },
    ];
        ...
        <div className="min-h-screen bg-black text-white">
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 pt-28 pb-20">
                ...
                >
                    {/* Heading */}
                    <div className="mb-12">
                        <h1 className="text-5xl font-black mb-3">{t('clauses.title')}</h1>
                        ...
                        {sections.map((section, i) => (
                            ...
                            >
                                ...
                                <div className="relative bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
                                    ...
                                    <p className="text-gray-400 text-sm leading-relaxed whitespace-pre-wrap">{section.content}</p>
                                </div>
                            </motion.div>
                        ))}
                    </div>
